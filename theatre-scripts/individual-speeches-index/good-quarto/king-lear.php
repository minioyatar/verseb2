...
<div class="row main-text">
	<div class="col-lg-9"><!-- #col-lg-9 introduction content -->
		<div class="well">
			<p style="color: #0099ff; ">QUARTO</p>
			<h3 class="page-title-ext text-center branding-style-reg" style="color: #0099ff; ">The Tragedy of King Lear</h3>
        <p>NOTE TO KING LEAR</p>
