...
<br>
		    ...
		    <p>We provide the world's largest range of Shakespeare theatre scripts The theatre 
		    	scripts mirror the text (final edit) of matching <i>e</i>Plays. &nbsp;</p> 
<br>
		    <p>DIFFERENCE BETWEEN A THEATRE SCRIPT AND AN <i>e</i>PLAY</p>
		    ...
		    <li><p><i>e</i>Plays - containing detailed annotations (definitions and meanings) and Versebuster's 
...
<br>
		    <p>THEATRE SCRIPTS - FULL-PLAY, SCENES INDIVIDUAL SPEECHES</p>
		    	 
		    <p>We provide theatre scripts either for the full play or just for individual speeches. &nbsp;For scenes just print the relevant pages from the full-play script (each scene begins on a new page to facilitate this).</p>

		     <p>A unique feature of our scripts for individual speeches is that they come, where applicable, with the cue lines for that speech. &nbsp;Cue lines, of course, provoke a reply and this feature helps 
...
<br>
		    ...
		    <p>Line numbers in the theatre scripts will correlate exactly with the line numbers 
		    	in the corresponding ePlay. &nbsp;This makes cross-reference easy. &nbsp;</p>
<br>
