...
<div class="container">
  ...
  <div class='row'>
	...
	<div class="row"><!-- #col-lg-9 introduction content -->
				...
				<div class="col-lg-4">
		            <fieldset >
				        <div class="field">
				            ...
				            <input type="text" name="fname" id="fname" value="<?php echo escape($user->data()->fname); ?>" autocomplete="off">
				        </div>    


				        <div class="field">
				            <label for="lname">Last Name</label>
				            <input type="text" name="lname" id="lname" value="<?php echo escape($user->data()->lname); ?>" autocomplete="off">
				        </div>    
