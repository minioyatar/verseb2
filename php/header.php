    	...
    	<div id="wrapper">
    		...
    		<div id="sidebar-wrapper">
    			...
    			<ul class="sidebar-nav ">
    				...
    				<li class="sub-sidebar-nav navi"><a href="/versebuster2/audio-speeches/audio-intro.php">Intro</a></li>
                    <li class="sub-sidebar-nav navi"><a href="/versebuster2/audio-speeches/audio-index.php">INDEX TO SPEECHES</a></li>
                    <li class="sub-sidebar-nav last-item navi"><a href="/versebuster2/audio-speeches/recording-notes.php">Recording notes</a></li>



    				<li><a><strong>ePlays</strong></a></li>

    				<li class="sub-sidebar-nav navi"><a href="/versebuster2/eplay/eplay-intro.php">Intro</a></li>
    				<!-- <li class="sub-sidebar-nav"><span class="list-title">Demo</span></li>
    				<li class="child-sub-sidebar-nav"><a>General layout</a></li>
    				<li class="child-sub-sidebar-nav last-item"><a>Notation system</a></li> -->

    				<li class="sub-sidebar-nav navi"><a href="/versebuster2/eplay/eplay-index.php">INDEX TO EPLAYS</a></li>
                    <li class="sub-sidebar-nav navi"><a href="/versebuster2/eplay/editorial-policy.php">Editorial policy</a></li>
                    <li class="sub-sidebar-nav last-item navi"><a href="/versebuster2/eplay/bibliography.php">Bibliography</a></li>


    				<li><a><strong>Theatre Scripts</strong></a></li>

    				<li class="sub-sidebar-nav navi"><a href="/versebuster2/theatre-scripts/theatre-script-intro.php">Intro</a></li>
    				<!-- <li class="sub-sidebar-nav"><span class="list-title">Demo</span></li>
    				<li class="child-sub-sidebar-nav"><a>Blank</a></li>
    				<li class="child-sub-sidebar-nav"><a>Basic notation</a></li>
    				<li class="child-sub-sidebar-nav last-item"><a>Advanced notation</a></li> -->
    					...
    					<nav id="" class="navbar navbar-inverse sub-main-nav " role="navigation">
    						...
    						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
    							<ul class="nav navbar-nav">
    								<li class="index navi highlight"><a href="/versebuster2/index.php"><strong>HOME</strong></a></li>
    								<li class="blog navi"><a href="/versebuster2/blog.php">BLOG</a></li>
    								<li class="forum navi"><a href="/versebuster2/forum.php">FORUM</a></li>
    								<li class="community navi"><a href="/versebuster2/community.php">COMMUNITY</a></li>
    								<li class="faq navi"><a href="/versebuster2/faq.php">FAQS</a></li>
    								<li class="copyright navi"><a href="/versebuster2/copyright.php">COPYRIGHT</a></li>	
    								<li class="contact navi"><a href="/versebuster2/contact.php">CONTACT</a></li>
    								<li class="shop navi"><a href="/versebuster2/shop.php"><strong>THE SHOP</strong></a></li>
    							</ul>
