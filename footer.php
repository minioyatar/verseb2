...
<!-- <div id="small-dialog" class="zoom-anim-dialog mfp-hide">
	...
	<!--end of quiz-->
		...
		<script>PDFObject.embed("<?php echo SITE_URL_FILE; ?>theatre-scripts/individual-speeches-index/modern/PDF/<?php echo 'TH_IS_STM_ 1_More_Act 2_[4]_Grant them removed-and grant that this your noise_2016.08.02_A3'; ?>.pdf", "#example1");</script>
		<script>PDFObject.embed("<?php echo SITE_URL_FILE; ?>theatre-scripts/individual-speeches-index/modern/PDF/<?php echo 'TH_IS_STM_ 1_More_Act 2.[4]_Grant them removed, and grant that this your noise_2016.08.01'; ?>.pdf", "#example2");</script>
