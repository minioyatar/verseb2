	...
	<div class="col-lg-9 "><!-- #col-lg-9 introduction content -->
        ...
        <br>         
            <div class="col-md-12" style="margin-bottom:20px">
                <div class="col-md-6">
                    <a style="width: 100%" href="<?php echo SITE_URL_FILE; ?>eplay/index-eplay" ><img class="img-responsive center-block" src="<?php echo SITE_URL_FILE; ?>images/square_eplay.jpg" style="width:75%; float: right;"></a>
                </div>
                <div class="col-md-6">
                    <a style="width: 100%" href="<?php echo SITE_URL_FILE; ?>theatre-scripts/full-play-index/index-full-play" ><img  class="img-responsive center-block"  src="<?php echo SITE_URL_FILE; ?>images/theatre_scripts.jpg" style="width:75%; float: left;"></a>
                </div>
            </div>

            <div class="col-md-12" style="margin-bottom:60px">
                <div class="col-md-6">
                    <a style="width: 100%" href="<?php echo SITE_URL_FILE; ?>audio-speeches/index-audio" ><img class="img-responsive center-block"  src="<?php echo SITE_URL_FILE; ?>images/square_audio.jpg" style="width:75%; float: right;"></a>
                </div>
                <div class="col-md-6">
                    <a style="width: 100%" href="<?php echo SITE_URL_FILE; ?>how-to-series" ><img class="img-responsive center-block"  src="<?php echo SITE_URL_FILE; ?>images/slide_square.jpg" style="width:75%; float: left;"></a>
                </div>
            </div>
        </div>
