...
<div class="row main-text">
	<div class="col-lg-9"><!-- #col-lg-9 introduction content -->
		<div class="well">
			...
			<p class="text-center"><b>POLITE REQUEST</b></p>
			<p class="text-center">We politely ask that our copyright is respected.</p> 
			<br>
			<p>ASSERTING COPYRIGHT</p>
			<p>We assert our copyright in three main ways:<p>
			
			<ul class="decimal-list">
				<li>
					<p>In 2012 we started registering strong supporting evidence of the evolution of our ideas with copyright 
						service companies across various territories, notably, but not restricted to, the UK, USA, Canada, 
						Australia and New Zealand.</p> 
				<li>
					<p>We use footprints and watermarking.</p>
				<li>
...
<br>
<br>
			<p>VERSEBUSTER PROPRIETARY SYSTEM OF NOTATION:</p>
			<p>Permission is granted to reproduce Versebuster's proprietary system of notation for personal and 
				educational use only. Commercial copying, hiring, lending is prohibited.</p>
<br>
<br>
			<p>VERSEBUSTER AUDIO RECORDINGS:</p>
			<p>Any unauthorised broadcasting, public performance, copying or re-recording will constitute an 
