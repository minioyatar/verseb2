...
<!-- 	    <div class="well" style="background-color:#F39C12">
		...
		<div class="well">
			...
			<p class="text-center"><b>ORIGINS OF SHAKESPEARE’S ART</b></p>
			<br>
			<p class="text-center"><i><a href="#">For slides shows to do with Elizabethan pronunciation, Elizabethan stagecraft & Elizabethan preoccupations and world view please click here</a></i></p>
			...
			<p>Conversely, in Shakespeare’s Comedies and late Romance plays people are happy by Act 5 to concede the error of their ways, kiss and make up (though not before sundry banishments, deaths, and other diabolical happenings along the way). </p>

			<br>
			<br>

			<p>THE SALIENT FACTS IN AN ATTRACTIVE FORMAT</p>
			...
			<ul style="list-style-image: url('<?php echo SITE_URL_FILE; ?>images/diamondBullet.gif');">
				...
				<li><p>Shakespeare’s lyrical period</p></li>
				<li><p>Shakespeare’s middle period</p></li>
				<li><p>Shakespeare’s late period</p></li>
			</ul>
		</div>
